...
function resto_scripts() {
	wp_enqueue_style( 'resto-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'resto-style', 'rtl', 'replace' );

	wp_enqueue_script( 'resto-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
